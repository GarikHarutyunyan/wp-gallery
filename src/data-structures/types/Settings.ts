...
export interface ISliderSettings {
  ...
  invertTextColor: boolean;
  thumbnailsPosition: LightboxThumbnailsPosition;
  thumbnailsAlignment: TextsAlignment;
  ...
  thumbnailTextPosition: SliderTextPosition;
  thumbnailTextFontFamily: string;
  thumbnailTextColor: string;
  thumbnailTextBackground: string;
  thumbnailInvertTextColor: boolean;
  thumbnailShowTitle: boolean;
  thumbnailTitleFontSize: number;
  thumbnailTitleAlignment: TitleAlignment;
  thumbnailShowDescription: boolean;
  thumbnailDescriptionFontSize: number;
  ...
  thumbnailCaptionFontColor: string;
