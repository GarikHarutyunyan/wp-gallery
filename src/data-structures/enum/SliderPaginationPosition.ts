export enum SliderPaginationPosition {
  TOP_LEFT = 'top-left',
...
export const SliderPaginationPositionOptions = [
  {value: SliderPaginationPosition.TOP_LEFT, title: 'Top Left'},
  {value: SliderPaginationPosition.TOP_CENTER, title: 'Top Center'},
  {value: SliderPaginationPosition.TOP_RIGHT, title: 'Top Right'},
  {value: SliderPaginationPosition.BOTTOM_LEFT, title: 'Bottom Left'},
  {value: SliderPaginationPosition.BOTTOM_CENTER, title: 'Bottom Center'},
