  ...
  const renderLighbox = () => {
    return (
      <Lightbox
        ...
        slides={slides}
        animation={{swipe: animation === LightboxImageAnimation.SLIDE_HORIZONTAL ? 500 : 1, easing: { swipe: "ease-out", navigation: "ease-in-out" }}}
        render={{
          // thumbnail: ({slide}) => {
        ...
        className={clsx('reacg-lightbox',
          'reacg-lightbox-animation-' + animation, {
