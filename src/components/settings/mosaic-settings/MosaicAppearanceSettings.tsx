...
import {HoverEffectOptions, IMosaicSettings} from 'data-structures';
import {
  ColorControl,
  SelectControl,
  SliderControl,
...
interface IMosaicAppearanceSettingsProps {
  settings: IMosaicSettings;
  onSettingsChange: (settings: IMosaicSettings) => void;
  isLoading: boolean;
}

const MosaicAppearanceSettings = ({
  settings,
  onSettingsChange,
  isLoading,
}: IMosaicAppearanceSettingsProps) => {
...
export {MosaicAppearanceSettings};
